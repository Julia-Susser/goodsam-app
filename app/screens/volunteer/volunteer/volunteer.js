...
export default class Volunteer extends Component{
  constructor(props) {
    ...
    firebase=async ()=>{
      ...
      db.ref('users/'+id).once('value', querySnapShot2 => {
...
db.ref('google_sheets/').once('value', querySnapShot => {
  console.log("https://sheets.googleapis.com/v4/spreadsheets/"+querySnapShot.val().sheet_id+"/values:batchGet?ranges=Sheet1&majorDimension=ROWS&key="+querySnapShot.val().access_token)
